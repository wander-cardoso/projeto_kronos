...
namespace ProjKronos.Controllers
{
    public class ProcessosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descricao,FuncionarioId,ClienteId,DataCriacao,DataLimite,TemCoima,SupervisorId,CategoriaId,PrioridadeId,Estado")] Processo processo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descricao,FuncionarioId,ClienteId,DataCriacao,DataLimite,TemCoima,SupervisorId,CategoriaId,PrioridadeId,Estado")] Processo processo)
        {
            if (id != processo.Id)
            {
                return NotFound();
